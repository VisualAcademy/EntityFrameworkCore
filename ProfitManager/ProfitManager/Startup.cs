...
namespace ProfitManager
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IProfitRepository, ProfitRepository>();
            services.AddTransient<IProfitSaleProvider, ProfitSaleProvider>();
            services.AddTransient<IProfitCostProvider, ProfitCostProvider>();
        }
